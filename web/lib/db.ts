...
export async function getSettings(): Promise<Settings> {
  ...
  const s: Record<string, unknown> = {
    ...
    retrain_min_days: 30, retrain_min_new_scored: 100, retrain_holdout_days: 14, pattern_min_examples: 30, news_trigger_importance: 60, signal_cooldown_min: 30, autopilot_enabled: true,
  };
